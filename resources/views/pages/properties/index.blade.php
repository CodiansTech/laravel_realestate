							...
							<div class="col-lg-12">
								<div class="main-banner-wrapper home10">
								    <div class="banner-style-one owl-theme owl-carousel">
								        <div class="slide slide-one" style="background-image: url({!! URL::asset('assets/images/home/1.jpg') !!});height: 600px;"></div>
								        <div class="slide slide-one" style="background-image: url({!! URL::asset('assets/images/home/2.jpg') !!});height: 600px;"></div>
								        <div class="slide slide-one" style="background-image: url({!! URL::asset('assets/images/home/1.jpg') !!});height: 600px;"></div>
								    </div>
			...
			<div class="row">
					...
					<div class="row">
								...
								<div class="property_video p0">
									<div class="thumb">
										...
										<div class="overlay_icon">
											<a href="#"><img class="map_img_icon" src="{{ URL::asset('assets/images/header-logo.png') }}" alt="header-logo.png"></a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="tab-content" id="myTabContent2">
									<div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
										<div class="property_video">
											<div class="thumb">
												<img class="pro_img img-fluid w100" src="{{ URL::asset('assets/images/background/7.jpg') }}" alt="7.jpg">
												<div class="overlay_icon">
						...
						<div class="col-lg-12">
							<div class="walkscore_area mt30">
								<h4 class="mb30">Walkscore <span class="float-right"><img src="{{ URL::asset('assets/images/resource/wscore.png') }}" alt="wscore.png"></span></h4>
							...
							<div class="product_single_content">
								<div class="mbp_pagination_comments mt30">
									...
									<div class="mbp_first media">
										<img src="{{ URL::asset('assets/images/testimonial/1.png') }}" class="mr-3" alt="1.png">
									...
									<div class="mbp_first media">
										<img src="{{ URL::asset('assets/images/testimonial/2.png') }}" class="mr-3" alt="2.png">
										<div class="media-body">
				...
				<div class="col-lg-4 col-xl-4 mt50">
					<div class="sidebar_listing_list">
						<div class="sidebar_advanced_search_widget">
							<div class="sl_creator">
								...
								<div class="media">
									<img class="mr-3" src="{{ URL::asset('assets/images/team/lc1.png') }}" alt="lc1.png">
									<div class="media-body">
								    	<h5 class="mt-0 mb0">Samul Williams</h5>
								    	<p class="mb0">(123)456-7890</p>
								    	<p class="mb0"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="761f18101936101f18121e190305135815191b">[email&#160;protected]</a></p>
					...
					<div class="terms_condition_widget">
						...
						<div class="sidebar_feature_property_slider">
							...
							<div class="item">
								<div class="feat_property home7 agent">
									<div class="thumb">
										<img class="img-whp" src="{{ URL::asset('assets/images/property/fp5.jpg') }}" alt="fp5.jpg">
										<div class="thmb_cntnt">
											<ul class="tag mb0">
												<li class="list-inline-item"><a href="#">For Rent</a></li>
												<li class="list-inline-item"><a href="#">Featured</a></li>
					...
					<div class="sidebar_feature_listing">
						...
						<div class="media">
							<img class="align-self-start mr-3" src="{{ URL::asset('assets/images/blog/fls1.jpg') }}" alt="fls1.jpg">
							<div class="media-body">
						...
						<div class="media">
							<img class="align-self-start mr-3" src="{{ URL::asset('assets/images/blog/fls2.jpg') }}" alt="fls2.jpg">
							<div class="media-body">
						...
						<div class="media">
							<img class="align-self-start mr-3" src="{{ URL::asset('assets/images/blog/fls3.jpg') }}" alt="fls3.jpg">
							<div class="media-body">
