                                        ...
                                        <section id="contact">
                                            ...
                                            <dl class="contact-fields">
                                                ...
                                                <dd><div class="form-group">
                                                    <input type="text" class="form-control" id="form-account-name" name="form-account-name" required value="{{Auth::user()->getName()}}">
                                                </div><!-- /.form-group --></dd>
                                                ...
                                                <dd><div class="form-group">
                                                    <input type="text" class="form-control" id="form-account-email" name="form-account-phone" value="{{Auth::user()->email}}">
                                                </div><!-- /.form-group --></dd>
