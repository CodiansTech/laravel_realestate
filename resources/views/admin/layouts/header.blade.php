		    ...
		    <nav>
		        ...
		        <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
	                ...
	                <li class="user_setting">
						<div class="dropdown">
	                		<a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="{{URL::asset('assets/images/team/e1.png')}}" alt="e1.png"> <span class="dn-1199">Ali Tufan</span></a>
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
						    		<img class="float-left" src="{{URL::asset('assets/images/team/e1.png')}}" alt="e1.png">
							    	<p>Ali Tufan <br><span class="address"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f0919c99848596919eb0979d91999cde939f9d">[email&#160;protected]</a></span></p>
						    	</div>
