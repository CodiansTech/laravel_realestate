...
<script type="text/javascript" src="{{ URL::asset('assets/js/markerwithlabel_packed.js')}}"></script>
...
<script type="text/javascript" src="{{ URL::asset('assets/js/jquery.raty.min.js') }}"></script>
